...
#'
#' @param phy A phylo object with time MRCA.
#' @param phy1 A second phylo object with cell division MRCA.
...
#'   \item{phy_sub}{Subtree from \code{phy}}
#'   \item{phy_sub1}{Subtree from \code{phy1}}
#' }
#'
#' @export
